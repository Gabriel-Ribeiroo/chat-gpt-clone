...
export default function Home() {
	return (
		<main className="flex flex-1 justify-center md:items-center overflow-auto">
			<div className="p-5 pb-0 text-gray-800 dark:text-white">
				...
				<div className="flex flex-col md:flex-row gap-5 md:mb-8 md:max-w-4xl">
					...
					<div className="flex flex-1 flex-col gap-5">
						...
						<div className="bg-gray-50 dark:bg-white/5 rounded p-3 text-center text-sm">
					...
					<div className="flex flex-1 flex-col gap-5">
						...
						<div className="bg-gray-50 dark:bg-white/5 rounded p-3 mb-5 text-center text-sm word-wrap">
